...
def launch_nodes_withconfig(context, *args, **kwargs):
    ...
    exit_event_handler_namespaced = RegisterEventHandler(
        ...
        event_handler=OnProcessExit(
            target_action=start_namespaced_rviz_cmd, on_exit=EmitEvent(event=Shutdown(reason="rviz exited"))
        ),
    )
...
def generate_launch_description():
    ...
    declare_launch_rviz_cmd = DeclareLaunchArgument(
        "launch_rviz", default_value="true", description="Whether to apply a namespace to the navigation stack"
    )
