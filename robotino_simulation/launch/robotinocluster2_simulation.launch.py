...
def launch_nodes_withconfig(context, *args, **kwargs):
    ...
    mpspawner = Node(
        ...
        name="mps_publisher",
        parameters=[mps_config, {"webots_world": "webots_robotinocluster2_sim.wbt"}],
        output="log",
    )

    # Starts Webots simulation and superwisor nodes
    webots = WebotsLauncher(
        world=PathJoinSubstitution([package_dir, "worlds", "modified_webots_robotinocluster2_sim.wbt"]),
        mode="realtime",
