...
class Robotino3IrScanMerger(Node):
    ...
    def __init__(self):
        super().__init__('robotino3_irscanmerger')
        ...
        self.publisher = self.create_publisher(LaserScan, '/robotino/ir_scan_merged', qos_profile=self.Laserscan_qos_profile)    
